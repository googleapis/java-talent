  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "le/api/resource.proto\032#google/cloud/talent/v4/common.proto\032$google/cloud/talent/v4/filters.proto\032&google/cloud/talent/v4/histogram.proto\032"
          + " google/cloud/talent/v4/job.proto\032#google/longrunning/operation"
          ...
          + "\003job\030\002 \001(\0132\033.google.cloud.talent.v4.JobB\003\340A\002\">\n\r"
          + "GetJobRequest\022-\n"
          + "\004name\030\001 \001(\tB\037\340A\002\372A\031\n"
          + "\027jobs.googleapis.com/Job\"r\n"
          + "\020UpdateJobRequest\022-\n"
          + "\003job\030\001 \001(\0132\033.google.cloud.talent.v4.JobB\003\340A\002\022/\n"
          ...
          + "\006parent\030\001 \001("
          + "\tB\037\340A\002\372A\031\022\027jobs.googleapis.com/Job\022I\n"
          + "\013search_mode\030\002"
          + " \001(\01624.google.cloud.talent.v4.SearchJobsRequest.SearchMode\022F\n"
          + "\020request_metadata\030\003"
          + " \001(\0132\'.google.cloud.talent.v4.RequestMetadataB\003\340A\002\0223\n"
          ...
          + " \001(\0162>.google.cloud.talent.v4.SearchJobsRequest.DiversificationLevel\022X\n"
          + "\023custom_ranking_info\030\016"
          + " \001(\0132;.google.cloud.talent.v4.SearchJobsRequest.CustomRankingInfo\022!\n"
          + "\025disable_keyword_match\030\020 \001(\010B\002\030\001\022V\n"
          + "\022keyword_match_mode\030\022"
          + " \001(\0162:.google.cloud.talent.v4.SearchJobsRequest.KeywordMatchMode\032\225\002\n"
          + "\021CustomRankingInfo\022j\n"
          + "\020importance_level\030\001"
          + " \001(\0162K.google.cloud.talent.v4.SearchJobsRequest.CustomRankingInfo.ImportanceLevelB\003\340A\002\022\037\n"
          ...
          + "\036DIVERSIFY_BY_LOOSER_SIMILARITY\020\005\"\207\001\n"
          ...
          + " \003(\01326.google.cloud.talent.v4.SearchJobsResponse.MatchingJob\022M\n"
          + "\027histogram_query_results\030\002"
          + " \003(\0132,.google.cloud.talent.v4.HistogramQueryResult\022\027\n"
          ...
          + "\010metadata\030\007 \001(\0132(.google.cloud.talent.v4.ResponseMetadata\022\"\n"
          + "\032broadened_query_jobs_count\030\010 \001(\005\022D\n"
          + "\020spell_correction\030\t"
          + " \001(\0132*.google.cloud.talent.v4.SpellingCorrection\032\322\001\n"
          + "\013MatchingJob\022(\n"
          ...
          + " \001(\01326.google.cloud.talent.v4.SearchJobsResponse.CommuteInfo\032y\n"
          + "\013CommuteInfo\0226\n"
          + "\014job_location\030\001 \001(\0132 .google.cloud.talent.v4.Location\0222\n"
          + "\017travel_duration\030\002 \001(\0132\031.google.protobuf.Duration\"y\n"
          ...
          + "\006parent\030\001 \001("
          + "\tB\037\340A\002\372A\031\022\027jobs.googleapis.com/Job\022.\n"
          + "\004jobs\030\002 \003(\0132\033.google.cloud.talent.v4.JobB\003\340A\002\022/\n"
          ...
          + "JOB_VIEW_FULL\020\0042\334\016\n\n"
          + "JobService\022\224\001\n"
          + "\tCreateJob\022(.google.cloud.talent.v4.CreateJobRequest\032\033.google.cloud.talent.v4.Job\"@\202\323\344\223\002-\"&/v4/{parent=projects/*/tenants/*}/jobs:\003job\332A\n"
          + "parent,job\022\341\001\n"
          + "\017BatchCreateJobs\022..google.cloud.talent.v4.BatchCreateJobsRequest\032\035.google.longrunning.Operation\"\177\202\323\344\223\0027\"2/v4/{parent=projects/*/tenants/*}/jobs:batchCreate:\001*\332A\013parent,jobs\312A1\n"
          + "\027BatchCreateJobsResponse\022\026BatchOperationMetadata\022\203\001\n"
          + "\006GetJob\022%.google.cloud.talent.v4.GetJobRequest\032\033.google.cloud.talent.v4.Job\"5\202\323\344\223\002(\022&/v4/{name=projects/*/tenants/*/jobs/*}\332A\004name\022\235\001\n"
          + "\tUpdateJob\022(.google.cloud.talent.v4.UpdateJobRequest\032\033.google.cloud.talent.v4.Job\"I\202\323\344\223\00212*/v4/{job.name=projects/*/tenants/*/jobs/*}:\003job\332A\017job,update_mask\022\341\001\n"
          + "\017BatchUpdateJobs\022..google.cloud.talent.v4.BatchUpdateJobsRequest\032\035.google.longrunning.Operation\"\177\202\323\344\223\0027\"2/v4/{parent=projects/*/tenants/*}/jobs:batchUpdate:\001*\332A\013parent,jobs\312A1\n"
          + "\027BatchUpdateJobsResponse\022\026BatchOperationMetadata\022\204\001\n"
          + "\tDeleteJob\022(.google.cloud.talent.v4.DeleteJobRequest\032\026.google.protobuf.Empty\"5\202\323\344\223\002(*&/v4/{name=projects/*/tenants/*/jobs/*}\332A\004name\022\343\001\n"
          + "\017BatchDeleteJobs\022..google.cloud.talent.v4.BatchDeleteJobsRequest\032\035.google.longrunning.Operation\"\200\001\202\323\344\223\0027\"2/v4/{parent=projects/*/tenants/*}/jobs:batchDelete:\001*\332A\014parent,names\312A1\n"
          + "\027BatchDeleteJobsResponse\022\026BatchOperationMetadata\022\235\001\n"
          + "\010ListJobs\022\'.google.cloud.talent.v4.ListJobsRequest\032(.google.cloud.talent.v4.ListJobsResponse\">\202\323\344\223\002(\022&/v4/{parent=projects/*/tenants/*}/jobs\332A\r"
          + "parent,filter\022\235\001\n\n"
          + "SearchJobs\022).google.cloud.talent.v4.SearchJobsRequest\032*.google.cloud.talent.v4.SearchJobsResponse\"8\202\323\344\223\0022\"-/v4/{parent=projects/*/tenants/*}/jobs:search:\001*\022\255\001\n"
          + "\022SearchJobsForAlert\022).google.cloud.talent.v4.Search"
          + "JobsRequest\032*.google.cloud.talent.v4.SearchJobsResponse\"@\202\323\344\223\002:\"5/v4/{parent=projects/*/tenants/*}/jobs:searchForAlert:\001*\032l\312A\023jobs.googleapis.com\322AShttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/jobsBs\n"
          + "\032com.google.cloud.talent.v4B\017JobServiceProtoP\001"
