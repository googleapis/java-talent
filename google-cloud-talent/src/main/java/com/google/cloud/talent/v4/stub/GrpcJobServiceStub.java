...
public class GrpcJobServiceStub extends JobServiceStub {
  ...
  private static final MethodDescriptor<PurgeJobsRequest, Operation> purgeJobsMethodDescriptor =
      MethodDescriptor.<PurgeJobsRequest, Operation>newBuilder()
          .setType(MethodDescriptor.MethodType.UNARY)
          .setFullMethodName("google.cloud.talent.v4.JobService/PurgeJobs")
          .setRequestMarshaller(ProtoUtils.marshaller(PurgeJobsRequest.getDefaultInstance()))
          .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
          .build();
  ...
  protected GrpcJobServiceStub(
    ...
    GrpcCallSettings<BatchDeleteJobsRequest, Operation> batchDeleteJobsTransportSettings =
        GrpcCallSettings.<BatchDeleteJobsRequest, Operation>newBuilder()
            ...
            .build();
    GrpcCallSettings<PurgeJobsRequest, Operation> purgeJobsTransportSettings =
        GrpcCallSettings.<PurgeJobsRequest, Operation>newBuilder()
