...
public class JobServiceSettings extends ClientSettings<JobServiceSettings> {
  ...
  public UnaryCallSettings<PurgeJobsRequest, Operation> purgeJobsSettings() {
    return ((JobServiceStubSettings) getStubSettings()).purgeJobsSettings();
  }

  /** Returns the object with the settings used for calls to purgeJobs. */
  public OperationCallSettings<PurgeJobsRequest, PurgeJobsResponse, BatchOperationMetadata>
      purgeJobsOperationSettings() {
    return ((JobServiceStubSettings) getStubSettings()).purgeJobsOperationSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<JobServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<PurgeJobsRequest, Operation> purgeJobsSettings() {
      return getStubSettingsBuilder().purgeJobsSettings();
    }
    ...
    public OperationCallSettings.Builder<
        ...
        purgeJobsOperationSettings() {
      return getStubSettingsBuilder().purgeJobsOperationSettings();
    }
