  ...
  public void createCompanyTest() throws Exception {
    Company expectedResponse =
        Company.newBuilder()
            ...
            .setHeadquartersAddress("headquarters_address-1879520036")
            .setHiringAgency(true)
            .setEeoText("eeo_text-1652097123")
            .setWebsiteUri("website_uri-2118185016")
            .setCareerSiteUri("career_site_uri1223331861")
            .setImageUri("image_uri-877823864")
