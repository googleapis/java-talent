...
public class JobServiceClientTest {
  ...
  public void createJobTest() throws Exception {
    Job expectedResponse =
        Job.newBuilder()
            ...
            .setJobDebugInfo(Job.JobDebugInfo.newBuilder().build())
            .build();
  ...
  @Test
  public void purgeJobsTest() throws Exception {
    PurgeJobsResponse expectedResponse =
        PurgeJobsResponse.newBuilder()
            .setPurgeCount(575305851)
            .addAllPurgeSample(new ArrayList<String>())
            .addAllJobResults(new ArrayList<JobResult>())
            .build();
    Operation resultOperation =
        Operation.newBuilder()
            .setName("purgeJobsTest")
            .setDone(true)
            .setResponse(Any.pack(expectedResponse))
            .build();
    mockJobService.addResponse(resultOperation);
    ...
    PurgeJobsResponse actualResponse = client.purgeJobsAsync(parent, filter).get();
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockJobService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    PurgeJobsRequest actualRequest = ((PurgeJobsRequest) actualRequests.get(0));
  ...
  @Test
  public void purgeJobsExceptionTest() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockJobService.addException(exception);
    ...
    try {
      ProjectName parent = ProjectName.of("[PROJECT]");
      String filter = "filter-1274492040";
      client.purgeJobsAsync(parent, filter).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
      Assert.assertEquals(InvalidArgumentException.class, e.getCause().getClass());
      InvalidArgumentException apiException = ((InvalidArgumentException) e.getCause());
  ...
  @Test
  public void purgeJobsTest2() throws Exception {
    PurgeJobsResponse expectedResponse =
        PurgeJobsResponse.newBuilder()
            .setPurgeCount(575305851)
            .addAllPurgeSample(new ArrayList<String>())
  ...
  @Test
  public void purgeJobsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockJobService.addException(exception);
  ...
  public void searchJobsTest() throws Exception {
    ...
    Assert.assertEquals(request.getEnableDebugInfo(), actualRequest.getEnableDebugInfo());
    ...
    Assert.assertEquals(request.getMendelDebugInput(), actualRequest.getMendelDebugInput());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
