...
public class JobServiceStubSettings extends StubSettings<JobServiceStubSettings> {
  ...
  private final UnaryCallSettings<PurgeJobsRequest, Operation> purgeJobsSettings;
  private final OperationCallSettings<PurgeJobsRequest, PurgeJobsResponse, BatchOperationMetadata>
      purgeJobsOperationSettings;
  ...
  /** Returns the object with the settings used for calls to purgeJobs. */
  public UnaryCallSettings<PurgeJobsRequest, Operation> purgeJobsSettings() {
    return purgeJobsSettings;
  }

  /** Returns the object with the settings used for calls to purgeJobs. */
  public OperationCallSettings<PurgeJobsRequest, PurgeJobsResponse, BatchOperationMetadata>
      purgeJobsOperationSettings() {
    return purgeJobsOperationSettings;
  }
  ...
  protected JobServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    purgeJobsSettings = settingsBuilder.purgeJobsSettings().build();
    purgeJobsOperationSettings = settingsBuilder.purgeJobsOperationSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<JobServiceStubSettings, Builder> {
    ...
    private final OperationCallSettings.Builder<
            BatchDeleteJobsRequest, BatchDeleteJobsResponse, BatchOperationMetadata>
        batchDeleteJobsOperationSettings;
    private final UnaryCallSettings.Builder<PurgeJobsRequest, Operation> purgeJobsSettings;
    private final OperationCallSettings.Builder<
            PurgeJobsRequest, PurgeJobsResponse, BatchOperationMetadata>
        purgeJobsOperationSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      purgeJobsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      purgeJobsOperationSettings = OperationCallSettings.newBuilder();
    ...
    protected Builder(JobServiceStubSettings settings) {
      ...
      purgeJobsSettings = settings.purgeJobsSettings.toBuilder();
      purgeJobsOperationSettings = settings.purgeJobsOperationSettings.toBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          .purgeJobsOperationSettings()
          .setInitialCallSettings(
              UnaryCallSettings.<PurgeJobsRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_params"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(PurgeJobsResponse.class))
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.create(BatchOperationMetadata.class))
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
    ...
    /** Returns the builder for the settings used for calls to purgeJobs. */
    public UnaryCallSettings.Builder<PurgeJobsRequest, Operation> purgeJobsSettings() {
      return purgeJobsSettings;
    }
