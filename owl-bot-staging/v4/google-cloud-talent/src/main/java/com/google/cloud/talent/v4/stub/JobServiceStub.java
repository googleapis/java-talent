...
public abstract class JobServiceStub implements BackgroundResource {
  ...
  public OperationCallable<PurgeJobsRequest, PurgeJobsResponse, BatchOperationMetadata>
    ...
    throw new UnsupportedOperationException("Not implemented: purgeJobsOperationCallable()");
  }

  public UnaryCallable<PurgeJobsRequest, Operation> purgeJobsCallable() {
    throw new UnsupportedOperationException("Not implemented: purgeJobsCallable()");
  }
