...
public final class CompletionServiceProto {
  ...
  static {
    ...
    internal_static_google_cloud_talent_v4_CompleteQueryRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_talent_v4_CompleteQueryRequest_descriptor,
        new java.lang.String[] { "Tenant", "Query", "LanguageCodes", "PageSize", "Company", "Scope", "Type", });
    internal_static_google_cloud_talent_v4_CompleteQueryResponse_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_talent_v4_CompleteQueryResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_talent_v4_CompleteQueryResponse_descriptor,
        new java.lang.String[] { "CompletionResults", "Metadata", });
    internal_static_google_cloud_talent_v4_CompleteQueryResponse_CompletionResult_descriptor =
      internal_static_google_cloud_talent_v4_CompleteQueryResponse_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_talent_v4_CompleteQueryResponse_CompletionResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_talent_v4_CompleteQueryResponse_CompletionResult_descriptor,
