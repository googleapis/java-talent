...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            event_ =
                input.readMessage(com.google.cloud.talent.v4.JobEvent.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public int getSerializedSize() {
    ...
    if (eventCase_ == 5) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(5, (com.google.cloud.talent.v4.JobEvent) event_);
    }
    if (!getEventNotesBytes().isEmpty()) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.talent.v4.JobEvent, com.google.cloud.talent.v4.JobEvent.Builder, com.google.cloud.talent.v4.JobEventOrBuilder> jobEventBuilder_;
    /**
     * <pre>
     * An event issued when a job seeker interacts with the application that
     * implements Cloud Talent Solution.
