...
public final class JobServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.talent.v4.PurgeJobsRequest,
      com.google.longrunning.Operation> getPurgeJobsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PurgeJobs",
      requestType = com.google.cloud.talent.v4.PurgeJobsRequest.class,
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.talent.v4.PurgeJobsRequest,
      com.google.longrunning.Operation> getPurgeJobsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.talent.v4.PurgeJobsRequest, com.google.longrunning.Operation> getPurgeJobsMethod;
    if ((getPurgeJobsMethod = JobServiceGrpc.getPurgeJobsMethod) == null) {
      synchronized (JobServiceGrpc.class) {
        if ((getPurgeJobsMethod = JobServiceGrpc.getPurgeJobsMethod) == null) {
          JobServiceGrpc.getPurgeJobsMethod = getPurgeJobsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.talent.v4.PurgeJobsRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PurgeJobs"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.talent.v4.PurgeJobsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new JobServiceMethodDescriptorSupplier("PurgeJobs"))
              .build();
        }
      }
    }
    return getPurgeJobsMethod;
  }
  ...
  public static abstract class JobServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void purgeJobs(com.google.cloud.talent.v4.PurgeJobsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPurgeJobsMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.cloud.talent.v4.PurgeJobsRequest,
                com.google.longrunning.Operation>(
                  this, METHODID_PURGE_JOBS)))
          .addMethod(
            getListJobsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class JobServiceStub extends io.grpc.stub.AbstractAsyncStub<JobServiceStub> {
    ...
    public void purgeJobs(com.google.cloud.talent.v4.PurgeJobsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPurgeJobsMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class JobServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<JobServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation purgeJobs(com.google.cloud.talent.v4.PurgeJobsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getPurgeJobsMethod(), getCallOptions(), request);
    }
  ...
  public static final class JobServiceFutureStub extends io.grpc.stub.AbstractFutureStub<JobServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation> purgeJobs(
        com.google.cloud.talent.v4.PurgeJobsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getPurgeJobsMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_PURGE_JOBS = 7;
  private static final int METHODID_LIST_JOBS = 8;
  private static final int METHODID_SEARCH_JOBS = 9;
  private static final int METHODID_SEARCH_JOBS_FOR_ALERT = 10;
      ...
      switch (methodId) {
        ...
        case METHODID_BATCH_DELETE_JOBS:
          serviceImpl.batchDeleteJobs((com.google.cloud.talent.v4.BatchDeleteJobsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_PURGE_JOBS:
          serviceImpl.purgeJobs((com.google.cloud.talent.v4.PurgeJobsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
